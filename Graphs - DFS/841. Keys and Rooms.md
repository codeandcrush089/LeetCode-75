...
![Medium](https://img.shields.io/badge/Level-Medium-yellow?style=for-the-badge) [![Problem Link](https://img.shields.io/badge/LeetCode-Link-orange?style=for-the-badge&logo=leetcode)](https://leetcode.com/problems/keys-and-rooms/description/)
...
* Treat each room as a node and keys as directed edges.
* Start DFS from room `0`.
* Visit all reachable rooms using the keys found.
* Track visited rooms to avoid revisiting.
* After traversal, check if all rooms were visited.
