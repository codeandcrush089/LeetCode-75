...
![Medium](https://img.shields.io/badge/Level-Medium-yellow?style=for-the-badge) [![Problem Link](https://img.shields.io/badge/LeetCode-Link-orange?style=for-the-badge&logo=leetcode)](https://leetcode.com/problems/successful-pairs-of-spells-and-potions/description/)
...
* Sort the `potions` array to enable efficient searching.
* For each `spell`, use binary search to find the **first potion** such that
  `spell × potion ≥ success`.
* All potions from that index to the end form successful pairs.
* Count them as `totalPotions − index`.
