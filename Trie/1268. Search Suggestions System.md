...
![Medium](https://img.shields.io/badge/Level-Medium-yellow?style=for-the-badge) [![Problem Link](https://img.shields.io/badge/LeetCode-Link-orange?style=for-the-badge&logo=leetcode)](https://leetcode.com/problems/search-suggestions-system/description/)
...
* Traverse the Trie character by character for each prefix of the search word.
* From the current Trie node, perform DFS to collect up to **3 lexicographically smallest** suggestions.
* Stop DFS early once 3 suggestions are found.
* Repeat for each prefix to build the final result.
