...
* Collisions occur only when a right-moving asteroid meets a left-moving one.
* Resolve collisions by comparing sizes and removing smaller asteroids.
* Push remaining asteroids into the stack.
