...
* **Min-Heap + Pointer (Greedy Design)**
* Maintain a pointer for the smallest number never popped.
* Use a min-heap to store numbers that are added back.
* Always pop from the heap if it’s non-empty; otherwise, use the pointer.
